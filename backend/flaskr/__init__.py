...
def create_app(test_config=None):
    ...
    def create_question():
        ...
        try:
            ...
            if not search:
                ...
                # if the json request contains search, a search will be implemented
    ...
    def retrieve_quizzes():
        ...
        # Get a list of all the filtered IDs in order to select a random number from it
        random_list = [question.id for question in questions]

        # Select one random question against the random list
        question = questions.filter(Question.id == random.choice(random_list)).first()
